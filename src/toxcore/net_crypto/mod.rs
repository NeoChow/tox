...
impl NetCrypto {
    ...
    pub fn new(args: NetCryptoNewArgs) -> NetCrypto {
        NetCrypto {
            udp_tx: args.udp_tx,
            dht_pk_tx: Arc::new(RwLock::new(OptionalSink::new())),
            connection_status_tx: Arc::new(RwLock::new(OptionalSink::new())),
    ...
    */
    ...
    pub fn set_dht_pk_sink(&self, dht_pk_tx: DhtPkTx) {
        self.dht_pk_tx.write().put(dht_pk_tx);
    }
    ...
    pub fn set_connection_status_sink(&self, connection_status_tx: ConnectionStatusTx) {
        self.connection_status_tx.write().put(connection_status_tx);
    }
}
